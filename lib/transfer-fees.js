...
export function estimateDebitFromGross(gross, commissionPct, feePct) {
...
export function maxGrossForDebitBudget(budget, commissionPct, feePct) {
 ...
 */
export function buildFeeAwareBulkTransferAmounts(totalBudget, perTransferGross, commissionPct, feePct) {
